...
const Blogs = () => {
    ...
    return (
        <div className="pt-20">
            ...
            <section className="bg-secondary-blue text-white py-8 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-primary-red/5 skew-x-12 translate-x-20"></div>
                
                <div className="container-custom relative z-10 text-center">
                    <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[10px] font-bold uppercase tracking-widest mb-3 backdrop-blur-md">
                        <span className="w-2 h-2 rounded-full bg-primary-red mr-3 animate-pulse"></span>
                        Latest from Astoria
                    </div>
                    <h1 className="font-poppins font-bold text-2xl md:text-3xl tracking-tight">
